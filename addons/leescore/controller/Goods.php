...
class Goods extends Base
{
    ...
    public function getList()
    {
        ...
        foreach ($list as $key => $vo) {
            ...
            $html .= "<li class=\"padding-bottom col-sm-6 col-md-4 col-lg-3 padding-top" . $borderRight . "\"><div class=\"f-list-box-item row\"><div class='products-img-box col-sm-12 col-xs-4'><a target='_blank' href=\"" . $detailURL . "\"><img class=\"pro-thumb center-block hidden-xs\" src=\"" . $vo['thumb'] . "\"><img class=\"pro-thumb visible-xs\" src=\"" . $vo['thumb'] . "\"></a></div><div class='col-xs-8 col-sm-12'><div class=\"col-sm-12\">" . $caseMoney . "</div><div class=\"col-sm-12\"><div class=\"w50 padd-r-15 text-muted pull-left ovh fz-12\">" . __('stock') . "：" . $beihuo . " </div></div><div class='clearfix'></div><div class=\"col-sm-12 margin-top text-center padding-none\"><a data-paramid=\"" . $vo['id'] . "\" data-url=\"" . addon_url('leescore/Cartapi/postCartAdd') . "\" href=\"javascript:;\" class=\"btn btn-success btn-sm add-cart " . $disabled . "\">+" . __('add cart') . "</a> &nbsp;&nbsp;&nbsp;<a target='_blank' href=\"" . $detailURL . "\" class=\"btn btn-danger btn-sm " . $disabled . "\">" . __('buy') . "</a></div><div class=\"clearfix\"></div></div></div></li></div>";
        }
